...
const RecoverTerminal = ({ navigation }) => {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={{ flex: 1 }}>
                ...
                <View>
                        <Text style={{ textAlign: 'center', fontSize: 20, fontWeight: 'bold', marginBottom: 15 }}>Terminal Recovery</Text>
                        ...
                        <Pressable style={{ alignSelf: 'center', backgroundColor: "green", paddingHorizontal: 20, paddingVertical: 10, borderRadius: 10, marginVertical: 20 }} onPress={() => console.log("Recover Button Clicked")}>
                            <Text style={{ fontSize: 15, color: "white" }}>Recover</Text>
                        </Pressable>
                    </View>
                </View>
            </View>
...
export default RecoverTerminal